...
public class CloudAnchorActivity extends AppCompatActivity
  ...
  private Button helpButton, testButton;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    prefs = getSharedPreferences("com.google.ar.core.examples.java.cloudanchor", MODE_PRIVATE);
    ...
    helpButton.setOnClickListener((view -> onHelpButtonPress()));
